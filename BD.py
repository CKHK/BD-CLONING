...
\033[1;91m [\033[1;94m✯\033[1;91m] \033[1;92mFACEBOOK : Qaiser Abbas  

\033[1;91m [\033[1;94m✯\033[1;91m] \033[1;92mFB GROUP : Fb Trick

\033[1;91m [\033[1;94m✯\033[1;91m] \033[1;92mGITHUB   : TechQaiser
...
class Main:
	...
	def api(self, uid, pwx):
		...
		sys.stdout.write(
			...
			"\r\r %s[QAISER] : %s/%s -> \033[0;97m [OK:%s ] \033[0;97m[CP:%s ]"%(W,self.loop, len(self.id), len(self.ok), len(self.cp))
